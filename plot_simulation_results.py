...
def plot_galaxy_evol():
    ...
    plt.plot(age_list_lognormal, SFR_list_lognormal, ls='dotted', label='log-normal, final model for the paper', c='0.5')
    plt.plot(age_list_extended, SFR_list_extended, color="tab:red", label='log-normal, temporary for demonstration')
    ...
    plt.plot(time_axis, stellar_mass_list, color="tab:orange", label='IGIMF')
    ...
    plt.plot(time_axis_fixedIMF, stellar_mass_list_fixedIMF, color="tab:blue", label='Canonical IMF')
    ...
    plt.plot([], [], label='log-norm SFH', color="tab:red")
    plt.plot([], [], label='IGIMF', color="tab:orange")
    plt.loglog(time_axis_fixedIMF, SNIa_number_per_century_fixedIMF, color="tab:blue")  # Number per century
    plt.loglog(time_axis_fixedIMF, SNII_number_per_century_fixedIMF, color="tab:blue", label='Canonical IMF', lw=0.5)  # Number per century
    ...
    plt.plot(log_time_axis, gas_Z_over_X_list, color="tab:orange", lw=0.7, label='IGIMF')
    ...
    plt.plot(log_time_axis_fixedIMF, gas_Z_over_X_list_fixedIMF, color="tab:blue", lw=0.7, label='Canonical IMF')
    ...
    plt.plot([], [], ls='dashed', lw=0.7, label='Stellar mass-weighted', color="k")
    plt.plot([], [], ls='dotted', lw=0.7, label='Stellar luminosity-weighted', color="k")
    plt.plot(log_time_axis, gas_Y_list, color='tab:orange', lw=0.7, label='IGIMF')
    ...
    plt.plot(log_time_axis_fixedIMF, gas_Y_list_fixedIMF, color="tab:blue", lw=0.7, label='Canonical IMF')
    ...
    plt.plot([], [], ls='dashed', lw=0.7, label='Stellar mass-weighted', color="k")
    plt.plot([], [], ls='dotted', lw=0.7, label='Stellar luminosity-weighted', color="k")
    plt.plot(log_time_axis, gas_Fe_over_H_list, color='tab:orange', lw=0.7, label='IGIMF')
    ...
    plt.plot(log_time_axis_fixedIMF, gas_Fe_over_H_list_fixedIMF, color='tab:blue', lw=0.7, label='Canonical IMF')
    ...
    plt.plot([], [], ls='dashed', lw=0.7, label='Stellar mass-weighted', color="k")
    plt.plot([], [], ls='dotted', lw=0.7, label='Stellar luminosity-weighted', color="k")
    plt.plot(log_time_axis, gas_Mg_over_Fe_list, color='tab:orange', lw=0.7, label='IGIMF')
    ...
    plt.plot(log_time_axis_fixedIMF, gas_Mg_over_Fe_list_fixedIMF, color='tab:blue', lw=0.7, label='Canonical IMF')
...
# Figure 44 1000_IMF_evolution
    ...
    plt.plot(time_axis, total_gas_mass_list, lw=3, ls='dotted', color="tab:orange")
    plt.plot(time_axis, ejected_gas_mass_list, ls='dotted', color="tab:orange")
    plt.plot(time_axis, stellar_mass_list, color="tab:orange", label='boxy SFH')
    plt.plot(time_axis, remnant_mass_list, ls='dashed', color="tab:orange")
    ...
    plt.plot(time_axis_extended, stellar_mass_list_extended, color="tab:red", label='log-norm SFH')
    ...
    plt.plot([], [], label='SNII', color="k", lw=0.5)
    plt.plot([], [], label='log-norm SFH', color="tab:red")
    plt.plot([], [], label='boxy SFH', color="tab:orange")
    ...
    plt.plot([], [], ls='dashed', lw=0.7, label='Stellar mass-weighted', color="k")
    plt.plot([], [], ls='dotted', lw=0.7, label='Stellar luminosity-weighted', color="k")
    plt.plot(log_time_axis, gas_Z_over_X_list, color="tab:orange", label='boxy SFH', lw=0.7)
    plt.plot(log_time_axis, stellar_Z_over_X_list, color="tab:orange", ls='dashed', lw=0.7)
    plt.plot(log_time_axis, stellar_Z_over_X_list_luminosity_weighted, ls='dotted', lw=0.7, color="tab:orange")
    plt.plot(log_time_axis_extended, gas_Z_over_X_list_extended, color="tab:red", label='log-norm SFH', lw=0.7)
    ...
    plt.plot([], [], ls='dashed', lw=0.7, label='Stellar mass-weighted', color="k")
    plt.plot([], [], ls='dotted', lw=0.7, label='Stellar luminosity-weighted', color="k")
    plt.plot(log_time_axis, gas_Y_list, color='tab:orange', lw=0.7, label='boxy SFH')
    plt.plot(log_time_axis, stellar_Y_list, color='tab:orange', lw=0.7, ls='dashed')
    plt.plot(log_time_axis, stellar_Y_list_luminosity_weighted, ls='dotted', lw=0.7, color="tab:orange")
    plt.plot(log_time_axis_extended, gas_Y_list_extended, color="tab:red", lw=0.7, label='log-norm SFH')
    ...
    plt.plot([], [], ls='dashed', lw=0.7, label='Stellar mass-weighted', color="k")
    plt.plot([], [], ls='dotted', lw=0.7, label='Stellar luminosity-weighted', color="k")
    plt.plot(log_time_axis, gas_Fe_over_H_list, color='tab:orange', lw=0.7, label='boxy SFH')
    plt.plot(log_time_axis, stellar_Fe_over_H_list, color='tab:orange', lw=0.7, ls='dashed')
    plt.plot(log_time_axis, stellar_Fe_over_H_list_luminosity_weighted, ls='dotted', lw=0.7, color="tab:orange")
    plt.plot(log_time_axis_extended, gas_Fe_over_H_list_extended, color='tab:red', lw=0.7, label='log-norm SFH')
    ...
    plt.plot([], [], ls='dashed', lw=0.7, label='Stellar mass-weighted', color="k")
    plt.plot([], [], ls='dotted', lw=0.7, label='Stellar luminosity-weighted', color="k")
    plt.plot(log_time_axis, gas_Mg_over_Fe_list, color='tab:orange', lw=0.7, label='boxy SFH')
    plt.plot(log_time_axis, stellar_Mg_over_Fe_list, color='tab:orange', lw=0.7, ls='dashed')
    plt.plot(log_time_axis, stellar_Mg_over_Fe_list_luminosity_weighted, ls='dotted', lw=0.7, color="tab:orange")
    plt.plot(log_time_axis_extended, gas_Mg_over_Fe_list_extended, color='tab:red', lw=0.7, label='log-norm SFH')
