...
def galaxy_evol(imf='igimf', STF=1, SFEN=1, Z_0=0.000000134, solar_abu_table_mass='Anders1989_mass',
    ...
    Z_solar = element_abundances_solar.function_solar_element_abundances(solar_abu_table_mass, 'Metal')
    X_solar = element_abundances_solar.function_solar_element_abundances(solar_abu_table_mass, 'H')
...
if __name__ == '__main__':
    ...
    galaxy_evol(imf='igimf', STF=0.3, SFEN=SFEN, Z_0=0.00000001886, solar_abu_table_mass="Anders1989_mass",
