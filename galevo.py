...
if __name__ == '__main__':
    ...
    #
    # # # #
    # # galaxy_evol(imf='igimf', STF=0.01896, SFEN=SFEN, Z_0=0.02*1e-5, solar_mass_component="Asplund2009_mass",
    # #             str_yield_table='Kobayashi06', IMF_name='Kroupa', steller_mass_upper_bound=150,
    # #             time_resolution_in_Myr=1, mass_boundary_observe_low=1.5, mass_boundary_observe_up=8,
    # #             SFH_model='gas_mass_dependent', SFE=0.001, SNIa_ON=True, SNIa_yield_table='Iwamoto1999',
    # #             solar_abu_table='Asplund2009',
    # #             high_time_resolution=None, plot_show=True, plot_save=True, outflow=100, check_igimf=None)
    ...
    #             high_time_resolution=None, plot_show=True, plot_save=True, outflow=100, check_igimf=None)
    #
    # # # IGIMF-R14 with a gas-depletion timescale 2.52 Gyr
    # # galaxy_evol(imf='igimf', STF=0.045, SFEN=SFEN, Z_0=0.02 * 1e-7, solar_mass_component="Asplund2009_mass",
    # #             str_yield_table='Kobayashi06', IMF_name='Kroupa', steller_mass_upper_bound=150,
    # #             time_resolution_in_Myr=1, mass_boundary_observe_low=1.5, mass_boundary_observe_up=8,
    # #             SFH_model='gas_mass_dependent', SFE=0.003968, SNIa_ON=True, SNIa_yield_table='Iwamoto1999',
    # #             solar_abu_table='Asplund2009',
    # #             high_time_resolution=None, plot_show=True, plot_save=True, outflow=100, check_igimf=None)


    # # Model 50 IGIMF-R14-L19DTD with a DTD similar to Lacchin19
    # # line 1795 1802
    # galaxy_evol(imf='igimf', STF=0.039, SFEN=SFEN, Z_0=0.02 * 1e-7, solar_mass_component="Asplund2009_mass",
    #             str_yield_table='Kobayashi06', IMF_name='Kroupa', steller_mass_upper_bound=150,
    #             time_resolution_in_Myr=1, mass_boundary_observe_low=1.5, mass_boundary_observe_up=8,
    #             SFH_model='gas_mass_dependent', SFE=0.0015, SNIa_ON=True, SNIa_yield_table='Iwamoto1999',
    #             solar_abu_table='Asplund2009',
    #             high_time_resolution=None, plot_show=True, plot_save=True, outflow=100, check_igimf=None)

    # # Model 50 IGIMF-R14-L19DTD2 with a DTD similar to Lacchin19 but normalized to have the same number of SNIa between 9 and 10 Gyr as Maoz's DTD.
    # galaxy_evol(imf='igimf', STF=0.039, SFEN=SFEN, Z_0=0.02 * 1e-7, solar_mass_component="Asplund2009_mass",
    #             str_yield_table='Kobayashi06', IMF_name='Kroupa', steller_mass_upper_bound=150,
    #             time_resolution_in_Myr=1, mass_boundary_observe_low=1.5, mass_boundary_observe_up=8,
    #             SFH_model='gas_mass_dependent', SFE=0.0015, SNIa_ON=True, SNIa_yield_table='Iwamoto1999',
    ...
    # #
    # Model 50 IGIMF-R14-SD with the Greggio 1983 SNIa rate
    galaxy_evol(imf='igimf', STF=0.039, SFEN=SFEN, Z_0=0.02 * 1e-7, solar_mass_component="Asplund2009_mass",
                str_yield_table='Kobayashi06', IMF_name='Kroupa', steller_mass_upper_bound=150,
                time_resolution_in_Myr=1, mass_boundary_observe_low=1.5, mass_boundary_observe_up=8,
